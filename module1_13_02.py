...
def is_in_beam_angle(angle, angle_range):
    return angle >= angle_range[0] and angle <= angle_range[1]

def main():
    # Step 1: Read input from CSV file
    input_file_path = r'C:\Users\IIT_ROPAR_User\Desktop\MTP\dir_2023_dataset_ropar_csv\RDILP_CSV_100_20_3.csv'
    nodes = []
    ...
    min_transmitters_required = len(all_powered_nodes)
