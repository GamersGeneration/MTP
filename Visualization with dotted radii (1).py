...
def visualize_network(file_path):
    ...
    for i in range(num_nodes):
        ...
        outer_circle = plt.Circle((x, y), radius, color=colors[i], fill=False, linestyle='dashed', alpha=0.7)
...
# Example usage
file_path = r'C:\Users\IIT_ROPAR_User\Desktop\MTP\dir_2023_dataset_ropar_csv\RDILP_CSV_50_10_3.csv'
